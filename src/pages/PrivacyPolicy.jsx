...
const PrivacyPolicy = () => {
    useEffect(() => {
        ...
        script.src = 'https://consent.cookiebot.com/4b0e76e3-75d4-421e-ab37-0982bcd952d9/cd.js';
        script.async = true;
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="glass-card p-6 md:p-10">
                    ...
                    <Section title="Cookie Declaration">
                        <p>
                            The table below is automatically generated by Cookiebot and lists all cookies detected
                            on this website, their purpose, and how long they are stored.
                        </p>
                        <div id="cookie-declaration-container" className="mt-4" />
                    </Section>
